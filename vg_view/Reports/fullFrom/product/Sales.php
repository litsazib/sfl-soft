					...
					?>
                     <tr class="gradeX" >
                       ...
                       <td class="center"><?php echo $this->Sales[$k]['final_amount'];?></td>
                         ...
                         <a  target="new" href="?SingelReport_salesINVPDF&getID=<?php echo $this->Sales[$k]['osm_full_id'];?>" class="btn"><i class="icon-print"></i></a>
                         
                         
                         
                          <a  href="?Sales_SalesUPdate&getID=<?php echo $this->Sales[$k]['osm_full_id'];?>" class="btn">
                            
                            <i class="icon-pencil"></i>
                          </a>
                          
                          <a  href="?Sales_SalesDelete&getID=<?php echo $this->Sales[$k]['osm_full_id'];?>" onclick="if (setPin()){return true;}else{event.stopPropagation(); event.preventDefault();}; " class="btn">
