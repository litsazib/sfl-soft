...
<div class="mainwrapper">
    ...
    <div class="leftpanel">
    	...
    	<div class="searchwidget">
        	<form action="http://demo.themepixels.com/webpage/katniss/results.html" method="post">
    	...
    	<div class="headerpanel">
            ...
            <div class="headerright">
    			...
    			<div class="dropdown userinfo">
                    <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="http://demo.themepixels.com/page.html">Hi, ThemePixels! <b class="caret"></b></a>
                    <ul class="dropdown-menu">
