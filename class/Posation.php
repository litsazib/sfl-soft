...
class Posation extends Crud{
	...
	public function FromDesign($file=false){
			if($file){
			return View."Posation/fromdesign/".$file.".php";
  ...
  public function CashReceived(){
    $this->LoginAllredy(true);
      if ($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $this->Paymentfrom=$this->FromDesign("frm_cash_rec");
        
        
        $file=View."Posation/".__FUNCTION__.'.php';
        if(file_exists($file)){
        require_once($file);
        }else{
